    ...
    return(
        <section className="container">
            ...
            <div>
                ...
                <p>
                Kenechukwu Ilochonwu, also known as Ken by his close friends is working as an Environmental Specialist, specifically tasked to ensure the protection and conservation of natural resources as well as establishing best practices to resolve complex issues. Ken believes achieving success in the workplace begins with having a strong mind, body and spirit which he channels through physical sports, competitive gaming, and travelling. 
                </p>
                <p>
                At the time of reviewing this portfolio, Ken would have completed a 6 month journey to becoming a full stack web developer, and by the end of this program, he would have acquired the necessary skills and knowledge to effeciently create and improve world wide web applications.
                </p>   
            </div>
        </section>
    ) 
