        ...
        <MDBRow className="pb-3">
          <MDBCol md="12">
            <div className="mb-5 flex-center">
              <a target='_blank' href="https://www.facebook.com/kilochonwu"className="fb-ic">
                <i className="fab fa-facebook-f fa-lg white-text mr-md-4"> </i>
              </a>
              <a target='_blank' href="https://github.com/kenesei91" className="gplus-ic">
                <i className="fab fa-google-plus-g fa-lg white-text mr-md-4">

                </i>
              </a>
              <a target='_blank' href="https://www.linkedin.com/in/kenechukwu-ilochonwu-98b34ba0/"className="li-ic">
